...
CREATE TABLE "ShippingSetting" (
    "id" TEXT NOT NULL,
    "flatRatePrice" DECIMAL(10,2) NOT NULL,
...
-- CreateIndex
CREATE INDEX "ColorImage_colorId_idx" ON "ColorImage"("colorId");
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_colorId_sizeId_key" ON "ProductVariant"("colorId", "sizeId");
